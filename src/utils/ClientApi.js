...
const userData= JSON.parse(localStorage.getItem('persist:deuil-pour-tous-redux'));
console.log(userData);
const token= JSON.parse(userData.userReducer).token? JSON.parse(userData.userReducer).token: null;
//const token= null;
